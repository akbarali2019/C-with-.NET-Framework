...
{
    public class FirestoreFivMinDataMap
    {
        public static Dictionary<string, object> MapDataForFirestore(IEnumerable<SendItem> items)
        {
            ...
            {
                var fireItem = FirestoreDataProperty.MapFivMinData(item);
